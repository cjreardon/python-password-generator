...
CheckVar4 = tk.IntVar()
CheckVar5 = tk.IntVar()
w1 = tk.Label(root, text="Password Length: (20 characters or less)", bg="black", fg='green', relief=tk.RIDGE) 
w1.grid(row=0, column=0, sticky='nsew') #sticky fills the GUI box
w2 = tk.Entry(root, textvariable=CheckVar5)
w2.grid(row=0, column=1)
w3 = tk.Checkbutton(root, text="Include lower-case? (a, b, c, etc.)", bg="black", fg='green', variable=CheckVar1, justify=tk.LEFT)
w3.grid(row=1, column=0, columnspan=2, sticky='nsew')
w4 = tk.Checkbutton(root, text="Include upper-case? (A, B, C, etc.)", bg="black", fg='green', variable=CheckVar2, justify=tk.LEFT)
w4.grid(row=2, column=0, columnspan=2, sticky='nsew')
w5 = tk.Checkbutton(root, text="Include numbers? (1, 2, 3, etc)", bg="black", fg='green', variable=CheckVar3, justify=tk.LEFT)
w5.grid(row=3, column=0, columnspan=2, sticky='nsew')
w6 = tk.Checkbutton(root, text="Include symbols? (!, @, #, etc)", bg="black", fg='green', variable=CheckVar4, justify=tk.LEFT)
